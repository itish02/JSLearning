...
const lufthansa = {
  ...
  book(flightNum, name) {
    ...
    this.bookings.push({ flight: `flight ${this.dataCode}${flightNum}`, name });
  },
};
...
book.call(lufthansa, 238, 'Itish Dhiman');
console.log(lufthansa);
...
book.call(swiss, 288, 'Tony Soprano');
console.log(swiss);

// Apply method
const flightData = [589, 'Tommy Shelby'];
...
BONUS TEST DATA 1: BONUS TEST DATA 1: [5, 2, 3]
